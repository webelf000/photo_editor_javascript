...
function() {
    "use strict";
    var Scale = Darkroom.Transformation.extend({
        applyTransformation: function(canvas, image, next) {
            var ratio = this.options.ratio;
            var width, height;
    ...
    Darkroom.plugins.resize = Darkroom.Plugin.extend({
        ...
        initialize: function() {
            ...
            //     image: "save"
            // }), this.resizeButton.addEventListener("click", this.options.callback.bind(this))

            var buttonGroup = this.darkroom.toolbar.createButtonGroup(),
            scaleUpButton = buttonGroup.createButton({
                image: "scale-up"
            }),
            scaleDownButton = buttonGroup.createButton({
                image: "scale-down"
            });
            scaleUpButton.addEventListener("click", this.scaleUp.bind(this)),
            scaleDownButton.addEventListener("click", this.scaleDown.bind(this))
        },
        scaleUp: function(ratio) {
            this.darkroom.applyTransformation(new Scale({ratio:1.2}));
        },
        scaleDown: function(ratio) {
            this.darkroom.applyTransformation(new Scale({ratio:(5 / 6)}));
        }
    })
}();